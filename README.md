...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9276&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qtpynodeeditor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qtpynodeeditor` can be installed with:

```
conda install qtpynodeeditor
```

It is possible to list all of the versions of `qtpynodeeditor` available on your platform with:
